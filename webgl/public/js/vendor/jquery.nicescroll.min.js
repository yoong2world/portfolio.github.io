...
$(function(){
	...
	if ($('html').hasClass('no-mobile') && $('html').hasClass('no-tablet')) {
		$('html').niceScroll({
			scrollspeed: 100,
	...
	function onScroll() {
		...
		$('.full-bg').each(function(){
			...
			var diffHeight = imgHeight - height;
			var py = (scrollTop - offsetTop + windowHeight);
			var pyPer = py / windowHeight;
			var posY = diffHeight * pyPer;
			posY -= height * .5;
			img.css('background-position-y', '' + -posY + 'px');
		});


		$('.anim-group').each(function(){
			var offsetTop = $(this).offset().top;
			if (offsetTop < scrollTop + windowHeight * .75) {
